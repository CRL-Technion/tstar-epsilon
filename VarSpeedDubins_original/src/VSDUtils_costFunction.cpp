...
double VarSpeedDubins::costFunction(arma::vec paramsShort, 
	...
	if (pathClass.compare("TST") == 0){
		//cost = R*(a1+g1+a2+g2) + r*(b1+b2) + L;
		cost = R * (a1 + g1 + a2 + g2 + b1 + b2) + L;
	}
	else if (pathClass.compare("TT") == 0){
		//cost = R*(a1+g1+a2+g2) + r*(b1+b2);
		cost = R * (a1 + g1 + a2 + g2 + b1 + b2);
	}
	else if (pathClass.compare("TTT") == 0){
		//cost = R*(a1+g1+a2+g2+a3+g3+a4+b4+g4) + r*(b1+b2+b3);
		cost = R * (a1 + g1 + a2 + g2 + a3 + g3 + a4 + b4 + g4 + b1 + b2 + b3);
	}
	else if (pathClass.compare("TTTT") == 0){
		//cost = R*(a1+g1+a2+g2+a3+g3+a4+g4)+ r*(b1+b2+b3+b4);
		cost = R * (a1 + g1 + a2 + g2 + a3 + g3 + a4 + g4 + b1 + b2 + b3 + b4);
	}
	return cost;
}
